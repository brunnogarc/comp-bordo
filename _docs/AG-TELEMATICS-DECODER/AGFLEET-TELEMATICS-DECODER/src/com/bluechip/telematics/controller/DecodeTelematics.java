...
public class DecodeTelematics {
	...
	public String decodeQtdMsgFLASH(String data) {
		String result = data.substring(14, 18);
		BigDecimal tmp = new BigDecimal(Long.valueOf(result,16));
		result = tmp + "";
		return result;
	}
	...
	public String decodeEngON(String data) {
		String result = data.substring(18, 20);
		int byte1 = Integer.parseInt(result,16);
	...
	public String decodeIdAlerta(String data) {
		String result = data.substring(20, 22);
		BigDecimal tmp = new BigDecimal(Long.valueOf(result,16));
		result = tmp + "";
		return result;
	}
	...
	public String decodeHorimetro(String data) {
		String result = data.substring(56, 64);
		if(result.equals("FFFFFFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeTotCombustivel(String data) {
		String result = data.substring(64, 72);
		if(result.equals("FFFFFFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeRPM(String data) {
		String result = data.substring(84, 88);
		if(result.equals("FFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeTempOleo(String data) {
		String result = data.substring(104, 108);
		if(result.equals("FFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeTempTrans(String data) {
		String result = data.substring(114, 118);
		if(result.equals("FFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeVazaoComb(String data) {
		String result = data.substring(122, 126);
		if(result.equals("FFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeVelColheita(String data) {
		String result = data.substring(136, 138);
		if(result.equals("FF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeHorimetroElevador(String data) {
		String result = data.substring(148, 156);
		if(result.equals("FFFFFFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeHorimetroPiloto(String data) {
		String result = data.substring(156, 164);
		if(result.equals("FFFFFFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodePressaoPicador(String data) {
		String result = data.substring(168, 172);
		if(result.equals("FFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	public String decodeAlturaCorteBase(String data) {
		String result = data.substring(172, 176);
		if(result.equals("FFFF")) {
			result = "Não avaliado";
		}else {
			double tmp = Long.valueOf(result,16);
	...
	//Parametro: Status da porta digital 05
	//Unidade: Ligado ou desligado
	public String decodePortaDigital(String data) {
		String result = data.substring(180, 182);
		int byte1 = Integer.parseInt(result,16);
		int tmp2 = (byte1 & 0b00000001);
		if(tmp2 == 0) {
			result = "OFF";
	...
	public String decodeCodUser(String data) {
		...
		result = data.substring(196, data.length() - 2);
	...
	//Paramtro: Codigo do usuario informado durante o snapshot (PROTOCOLO V1)
		public String decodeCodUserOld(String data) {
			String result = "FFFFFFFFFFFFFFFF";
			result = data.substring(148, data.length() - 2);
			if(result.equals("FFFFFFFFFFFFFFFF")) {
				result = "Não informado";
			}else {
				double tmp = Long.valueOf(result,16);
